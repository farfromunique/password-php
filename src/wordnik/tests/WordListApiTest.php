...
class WordListApiTest extends BaseApiTest
{
    ...
    {
        parent::setUp();
        $this->authToken = $this->accountApi->authenticate(
        $this->username,
        $this->password
    )->token;
    ...
    {
        $res = $this->wordListApi->getWordListByPermalink(
        $this->existingList->permalink,
        $this->authToken
    );
    ...
    public function testUpdateWordList()
    {
        ...
        $this->wordListApi->updateWordList(
        $this->existingList->permalink,
    ...
    public function testAddWordsToWordList()
    {
        ...
        $this->wordListApi->addWordsToWordList(
        $this->existingList->permalink,
        $body=$wordsToAdd,
        $this->authToken
    );
    ...
    public function testDeleteWordsFromList()
    {
        ...
        $this->wordListApi->deleteWordsFromWordList(
        $this->existingList->permalink,
        $body=$wordsToRemove,
        $this->authToken
    );
